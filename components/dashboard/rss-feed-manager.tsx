...
import { getRssFeedsBytUserId } from "@/actions/rss-feed";
...
export async function RssFeedManager() {
  ...
  const feeds = (await getRssFeedsBytUserId(user.id)) as RssFeed[];
        ...
        {feeds.length === 0 ? (
          <div className="text-center py-12">
            ...
            <AddFeedDialog
              ...
              isPro={isPro}
              trigger={
                <Button className="bg-linear-to-r from-blue-600 to-pink-600 hover:from-blue-700 hover:to-pink-700 text-white">
